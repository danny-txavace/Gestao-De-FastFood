...
@Component({
  selector: 'app-create-cash-register-dialog',
  imports: [Ripple, FloatLabel, FormsModule, InputIcon, IconField, ReactiveFormsModule, InputTextModule, Dialog, SelectModule, InputNumber, TextareaModule, TranslateModule],
  templateUrl: './create-cash-register-dialog.html',
  styleUrl: './create-cash-register-dialog.scss',
})
export class CreateCashRegisterDialog implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.subs.add(
      this.dialogCreateRep.currentDialog$.subscribe(value => {
        if (value.format === 'create-cash_register')
        {
